...
- بياناتك محفوظة محليا على جهازك، ولا يحتاج البرنامج إلى حساب أو تسجيل دخول.
- لا يحتوي البرنامج على إعلانات أو تتبع، ولا يرسل بياناتك المالية أو مرفقاتك تلقائيا إلى أي جهة.
- عند استخدام زر الدعم، يتم إرسال البيانات التي تكتبها في رسالة الدعم فقط لمساعدتك في حل المشكلة.
- الفواتير والإيصالات تحفظ محليا داخل بيانات البرنامج، ويقبل البرنامج الصور وملفات PDF فقط كمرفقات.
- عند استيراد نسخة احتياطية، يتحقق البرنامج من محتواها قبل استبدال البيانات الحالية.
